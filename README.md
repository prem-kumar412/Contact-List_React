...
2. [Download the source code](https://github.com/prem-kumar412/Contact-List_React.git) and open a command prompt in the project's root folder.
...
The Contact List is deployed and accessible online. You can use the following link to access the application: [Contact List](https://contact-list-premkumar.netlify.app/)
